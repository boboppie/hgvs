...
# REF http://www.arup.utah.edu/database/OCTN2/OCTN2_display.php
# REF https://cgwb.nci.nih.gov/cgi-bin/hgTables?db=hg19&hgta_group=genes&hgta_track=refGene&hgta_table=refGene&hgta_doSchema=describe+table+schema
